/**
 * Mirabiliss V2 — Beograd
 *
 * Clone of mirabiliss with corrected specialties — "Interna medicina" removed
 * (not confirmed on the official website) — original left unchanged.
...
import { Flower2, Scissors, Wand2 } from "lucide-react";

export const mirabiliss_v2: DemoConfig = {
  slug: "mirabiliss-v2",
  brand: "MIRABILISS",
  category: "Poliklinika · Beograd",
  name: "Mirabiliss",
  description:
    "Ginekologija i akušerstvo, plastična/rekonstruktivna i estetska hirurgija, opšta hirurgija — kompletna nega za ženu i porodicu, uz online zakazivanje.",
  theme: "medical",
  hero: {
    lead: "Vaše zdravlje",
    emphasis: "i lepota, na jednom mestu.",
    subtext:
      "Ginekologija, plastična/estetska hirurgija i opšta hirurgija — izaberite specijalnost, lekara i termin online.",
    icon: Flower2,
  ...
  seo: {
    ...
    description:
      "Ginekologija, plastična/estetska hirurgija i opšta hirurgija u Beogradu. Izaberite specijalnost i termin — zakažite online.",
  },
};
