...
export const poliklinika_human: DemoConfig = {
  ...
  specialties: [
    ...
    { id: "radiologija", name: "Radiologija", icon: ScanSearch, color: "oklch(0.55 0.12 280)" },
    { id: "interna", name: "Interna medicina", icon: ShieldPlus, color: "oklch(0.55 0.10 195)" },
    { id: "dojke", name: "Kabinet za bolesti dojke", icon: Ribbon, color: "oklch(0.65 0.14 340)" },
  ],
  ...
  services: [
    ...
    },
    {
      ...
      description: "Komprehenzivni sistematski pregled sa svim neophodnim analizama i dijagnostikom.",
      duration: 60,
      price: 12000,
      specialtyId: "interna",
    },
